...
local function negated(fn) return function() return not fn() end end
...
galaxyline.short_line_list = {
    'dbui', 'diff', 'peekaboo', 'undotree', 'vista', 'vista_markdown'
}
        ...
        ViMode = {
            provider = function() -- auto change color according the vim mode
                ...
                if vim.g.libmodalActiveModeName then
                    ...
                    local current_mode =
                        _MODES[mode(true)] or _MODES[mode(false)]
    ...
    -- }},
    {
        LeftEnd = {
            ...
            highlight = {
                ...
                find_git_root() and _HEX_COLORS.green_dark or
                    _HEX_COLORS.bar.side
            }
        }
    }, {
        DiffAdd = {
        ...
        DiagnosticError = {
            ...
            separator = ' ',
            separator_highlight = {
                _HEX_COLORS.bar.middle, _HEX_COLORS.bar.middle
            }
        }
    }, {
        DiagnosticWarn = {
